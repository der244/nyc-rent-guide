                    ...
                    <TableBody>
                      ...
                      <TableRow className="border-b-2">
                        <TableCell className="font-bold text-base sm:text-lg text-calculator-success">
                          <div className="space-y-2">
                            <div className="text-base sm:text-xl font-bold">{formatCurrency(inputs.currentRent)}</div>
                            <div className="text-base sm:text-xl text-foreground">Legal Regulated Rent</div>
                            <div className="flex justify-center">
                              <Button
                      ...
                      {inputs.preferentialRent && scenarios.oneYear?.preferentialResult && scenarios.twoYear?.preferentialResult && (
                        <TableRow className="bg-calculator-info/5">
                          <TableCell className="font-semibold text-calculator-info text-base sm:text-lg">
                            <div className="space-y-2">
                              <div className="text-base sm:text-xl font-bold">{formatCurrency(inputs.preferentialRent)}</div>
                              <div className="text-base sm:text-xl text-foreground">Preferential Rent (Tenant Pays)</div>
                              <div className="flex justify-center">
                                <Button
