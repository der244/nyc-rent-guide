  ...
  return <div className="space-y-6">
      ...
      <div className="print-only hidden print:block">
        <div className="text-center mb-3">
          <h1 className="text-lg font-bold">NYC Rent Stabilized Renewal Calculation</h1>
          <p className="text-xs">Generated By: http://nyclmg.com</p>
          <div className="text-xs mt-1">
            {inputs.tenantName && <span><strong>Tenant:</strong> {inputs.tenantName} | </span>}
            {inputs.address && <span><strong>Property:</strong> {inputs.address} | </span>}
            {inputs.unit && <span><strong>Unit:</strong> {inputs.unit} | </span>}
            <span><strong>Lease Start:</strong> {inputs.leaseStartDate.toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' })} | </span>
            <span><strong>Calculated:</strong> {new Date().toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' })}</span>
          </div>
          <p className="text-xs mt-1">
            <strong>Effective Period:</strong> {new Date(scenarios.effectivePeriod.split(' to ')[0]).toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' })} to {new Date(scenarios.effectivePeriod.split(' to ')[1]).toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' })}
          </p>
        </div>
        ...
        <table className="w-full border border-gray-300">
          <thead>
            <tr className="border-b border-gray-300">
              <th className="text-left p-1 font-bold text-xs">Current Rent</th>
              <th className="text-center p-1 font-bold text-xs">1-Year Lease Option</th>
              <th className="text-center p-1 font-bold text-xs">2-Year Lease Option</th>
            </tr>
          </thead>
          <tbody>
            {/* Legal Rent Row */}
            <tr className="border-b border-gray-300">
              <td className="p-1">
                <div className="text-sm font-bold">{formatCurrency(inputs.currentRent)}</div>
                <div className="text-xs">Legal Regulated Rent</div>
                <div className="text-xs mt-1">
                  <strong>1yr end:</strong> {new Date(inputs.leaseStartDate.getFullYear() + 1, inputs.leaseStartDate.getMonth(), inputs.leaseStartDate.getDate() - 1).toLocaleDateString("en-US", { month: "2-digit", day: "2-digit", year: "numeric" })}
                </div>
                <div className="text-xs">
                  <strong>2yr end:</strong> {new Date(inputs.leaseStartDate.getFullYear() + 2, inputs.leaseStartDate.getMonth(), inputs.leaseStartDate.getDate() - 1).toLocaleDateString("en-US", { month: "2-digit", day: "2-digit", year: "numeric" })}
                </div>
              </td>
              <td className="text-center p-1">
                ...
                <div className="text-xs">
                  {scenarios.oneYear?.increases.length === 2 ? `${formatPercent(scenarios.oneYear.increases[0].percentIncrease)} / ${formatPercent(scenarios.oneYear.increases[1].percentIncrease)}` : `${formatPercent(scenarios.oneYear?.increases[0]?.percentIncrease || 0)}`}
                </div>
                <div className="text-xs">
                  {scenarios.oneYear?.increases.length === 2 ? `${formatCurrency(scenarios.oneYear.increases[0].dollarIncrease)} / ${formatCurrency(scenarios.oneYear.increases[1].dollarIncrease)}` : `${formatCurrency(scenarios.oneYear?.increases[0]?.dollarIncrease || 0)}`}
                </div>
              </td>
              <td className="text-center p-1">
                <div className="text-sm font-bold">
                ...
                <div className="text-xs">
                  {scenarios.twoYear?.increases.length === 2 ? `${formatPercent(scenarios.twoYear.increases[0].percentIncrease)} / ${formatPercent(scenarios.twoYear.increases[1].percentIncrease)}` : `${formatPercent(scenarios.twoYear?.increases[0]?.percentIncrease || 0)}`}
                </div>
                <div className="text-xs">
                  {scenarios.twoYear?.increases.length === 2 ? `${formatCurrency(scenarios.twoYear.increases[0].dollarIncrease)} / ${formatCurrency(scenarios.twoYear.increases[1].dollarIncrease)}` : `${formatCurrency(scenarios.twoYear?.increases[0]?.dollarIncrease || 0)}`}
                </div>
              </td>
            </tr>
            ...
            {inputs.preferentialRent && <tr className="border-b border-gray-300">
                <td className="p-1">
                  <div className="text-sm font-bold">{formatCurrency(inputs.preferentialRent)}</div>
                  <div className="text-xs">Tenant Currently Pays (Preferential)</div>
                </td>
                <td className="text-center p-1">
                  {scenarios.oneYear?.preferentialResult && <>
                      ...
                      <div className="text-xs">
                        {scenarios.oneYear.increases.length === 2 && scenarios.oneYear.preferentialResult.year1Amount ? `${formatPercent(scenarios.oneYear.increases[0].percentIncrease)} / ${formatPercent(scenarios.oneYear.increases[1].percentIncrease)}` : `${formatPercent(scenarios.oneYear?.increases[0]?.percentIncrease || 0)}`}
                      </div>
                    </>}
                </td>
                <td className="text-center p-1">
                  {scenarios.twoYear?.preferentialResult && <>
                      ...
                      <div className="text-xs">
                        {scenarios.twoYear.increases.length === 2 && scenarios.twoYear.preferentialResult.year1Amount ? `${formatPercent(scenarios.twoYear.increases[0].percentIncrease)} / ${formatPercent(scenarios.twoYear.increases[1].percentIncrease)}` : `${formatPercent(scenarios.twoYear?.increases[0]?.percentIncrease || 0)}`}
                      </div>
                    </>}
                </td>
              </tr>}
